...
sld-import-error-no-file = Selecciona un archivo SLD para importar
...
spatial-index-view-notice = Esta es una vista de la base de datos — el índice espacial no se puede verificar automáticamente. Revisa el índice en la tabla base.
...
metadata-empty-subtitle = Publica una capa en el catálogo para poder añadirle metadatos.
