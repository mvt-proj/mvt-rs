...
time_in_seconds = El tiempo debe ingresarse en segundos
value_infinity = Un valor de 0 significa edad infinita
published = Publicada
allowed-groups = Grupos Permitidos
empty-allowed-groups = Si está vacío, todos los grupos están permitidos
yes = Sí
no = No
