...
apply-style = Aplicar
view-map = Ver Mapa
map-preview-title = Vista previa del mapa
...
copy = Copiar
map = Mapa
inspect-layer = Inspeccionar capa
legends = Leyendas
info = Información
edit = Editar
...
qml-import-error-too-large = El archivo QML es demasiado grande para convertir
qml-import-error-no-file = Seleccioná un archivo QML para importar
qml-import-no-layers = No hay capas disponibles
sld-import-title = Importar desde SLD
sld-import-toggle = Mostrar / ocultar
sld-import-file-label = Archivo SLD
sld-import-source-layer-label = Capa
sld-import-mode-label = Modo de conversión
sld-import-mode-compact = Solo MapLibre
sld-import-mode-qgis = Compatible con QGIS
sld-import-merge-label = Modo de combinación
sld-import-merge-concat = Concatenar
sld-import-merge-replace = Reemplazar
sld-import-button = Importar SLD
sld-import-warnings-title = Avisos de conversión
sld-import-error-generic = No se pudo convertir el archivo SLD
sld-import-error-too-large = El archivo SLD es demasiado grande para convertir
sld-import-error-no-file = Seleccioná un archivo SLD para importar
sld-import-no-layers = No hay capas disponibles
geometry = Geometría
points = Puntos
lines = Líneas
polygons = Polígonos
...
clip-geom = Clip Geom
label-layer = Capa de etiquetas
info-label-layer = Agrega una capa MVT "_labels" con un punto por entidad (ST_PointOnSurface), para que las etiquetas no se repitan entre los tiles que una entidad atraviesa. Solo aplica a líneas y polígonos.
spatial-index-missing-warning = No se encontró un índice espacial (GiST/SP-GiST/BRIN) sobre esta columna de geometría. Las consultas de tiles pueden ser lentas sin uno — índice sugerido:
spatial-index-view-notice = Esta es una vista de la base de datos — el índice espacial no se puede verificar automáticamente. Revisá el índice en la tabla base.
