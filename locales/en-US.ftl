...
index-subtitle = Serve PostGIS layers as Mapbox Vector Tiles with caching, authentication, and style management.
home-capabilities = Capabilities
home-cta-catalog = View Catalog
home-cta-styles = View Styles
home-cta-admin = Admin Panel
feature-1 = Vector Tiles
feature-1-desc = Serve PostGIS tables and views as .pbf tiles with Redis or disk caching.
feature-2 = Style Server
feature-2-desc = Publish and share MapLibre/Mapbox styles from the integrated style server.
feature-3 = Access Control
feature-3-desc = Manage users and groups with JWT authentication and per-layer permissions.
feature-4 = Multi-Database
feature-4-desc = Connect multiple PostGIS databases simultaneously and serve layers from each independently.
feature-5 = Lua Plugins
feature-5-desc = Inject custom SQL filters at runtime via Lua scripts — per-layer or per-category, with access to user, groups, and zoom level.
feature-6 = Metadata (coming soon)
feature-6-desc = ISO 19115 compliant metadata server for spatial data documentation.
...
confirm-delete-cache = Are you sure you want to delete the cache for this layer?
...
info = Info
edit = Edit
switch-published = Publish / Unpublish
...
qml-import-error-too-large = The QML file is too large to convert
qml-import-error-no-file = Select a QML file to import
qml-import-no-layers = No layers available
geometry = Geometry
points = Points
lines = Lines
polygons = Polygons
...
plugins = Plugins
no-plugins-found = No plugins installed
plugins-dir-hint = Place .lua files in the plugins directory to get started.
plugin-layer = Layer
