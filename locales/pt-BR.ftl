...
qml-import-error-too-large = O arquivo QML é muito grande para ser convertido
qml-import-error-no-file = Selecione um arquivo QML para importar
qml-import-no-layers = Nenhuma camada disponível
geometry = Geometria
points = Pontos
lines = Linhas
polygons = Polígonos
